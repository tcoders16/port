...
export default function About() {
    return (
      <>
        <div className=' font-poppins-light m-20'>
            ...
            <p style={{ marginTop: '20px', marginBottom: '20px' }}>
              My main focus these days is building accessible user interfaces for our customers at <strong>Klaviyo</strong>. I most enjoy building software in the sweet spot where design and engineering meet — things that look good but are also built well under the hood. In my free time, I've also released an online video course that covers everything you need to know to build a web app with the Spotify API.
            </p>
            <p style={{ marginTop: '20px', marginBottom: '20px' }}>
